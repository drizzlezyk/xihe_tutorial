...
# basic parameters
parser.add_argument('--platform', type=str, default='GPUGPU', help='only support GPU and Ascend')
...
parser.add_argument('--image_size', type=int, default=150, help='input image_size, default is 150.')
...
parser.add_argument('--max_epoch', type=int, default=50, help='epoch size for training, default is 200.')
...
parser.add_argument('--data_path', default='./img/', \
...
parser.add_argument('--G_A_ckpt', type=str, default='./outputs/ckpt/G_A_1.ckpt', \
                    help='checkpoint file path of G_A.')
parser.add_argument('--G_B_ckpt', type=str, default='./outputs/ckpt/G_B_1.ckpt', \
                    help='checkpoint file path of G_B.')
parser.add_argument('--D_A_ckpt', type=str, default='./outputs/ckpt/D_A_1.ckpt', \
                    help='checkpoint file path of D_A.')
parser.add_argument('--D_B_ckpt', type=str, default='./outputs/ckpt/D_B_1.ckpt', \
...
parser.add_argument('--save_imgs', type=ast.literal_eval, default=False, \
                    help='whether save imgs when epoch end')
parser.add_argument('--use_random', type=ast.literal_eval, default=False, \
