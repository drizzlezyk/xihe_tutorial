...
# basic parameters
parser.add_argument('--platform', type=str, default='CPU', help='only support GPU and Ascend')
...
parser.add_argument('--image_size', type=int, default=256, help='input image_size, default is 150.')
...
parser.add_argument('--max_epoch', type=int, default=100, help='epoch size for training, default is 200.')
...
parser.add_argument('--lambda_idt', type=float, default=0.1, \
                    help='use identity mapping. Setting lambda_identity other than 0 has an effect of scaling the '
                         'weight of the identity mapping loss. For examples, if the weight of the identity loss '
...
parser.add_argument('--data_path', default='./vangogh/', \
...
parser.add_argument('--load_ckpt', type=ast.literal_eval, default=True, \
                    help='whether load pretrained ckpt')
parser.add_argument('--G_A_ckpt', type=str, default='./outputs/ckpt/G_A_58.ckpt', \
                    help='checkpoint file path of G_A.')
parser.add_argument('--G_B_ckpt', type=str, default='./outputs/ckpt/G_B_58.ckpt', \
                    help='checkpoint file path of G_B.')
parser.add_argument('--D_A_ckpt', type=str, default='./outputs/ckpt/D_A_58.ckpt', \
                    help='checkpoint file path of D_A.')
parser.add_argument('--D_B_ckpt', type=str, default='./outputs/ckpt/D_B_58.ckpt', \
